...
const sectionNavItems = [
  ...
  { id: "threat-actors", label: "Threat Actors", icon: BugReportIcon },
  { id: "methodology", label: "CTI Methodology", icon: PsychologyIcon },
  { id: "iocs-mitre", label: "IOCs & MITRE", icon: RadarIcon },
  { id: "threat-landscape", label: "Threat Landscape", icon: PublicIcon },
  { id: "tracking-tools", label: "Tracking & Tools", icon: TrackChangesIcon },
  { id: "defensive-intel", label: "Defensive Intel", icon: ShieldIcon },
  ...
  const sidebarNav = (
    <Box sx={{ p: 2 }}>
      ...
      {sectionNavItems.map((item, index) => {
        ...
        const progress = ((index + 1) / sectionNavItems.length) * 100;
        return (
          <Box
            key={item.id}
            ...
            sx={{
              ...
              borderLeft: `3px solid ${isActive ? themeColors.primary : "transparent"}`,
  ...
  return (
    <LearnPageLayout pageTitle="Cyber Threat Intelligence" pageContext={pageContext}>
          ...
          <Grid item xs={12} md={9.5}>
            ...
            <Box id="intro" sx={{ scrollMarginTop: 80 }}>
              ...
              >
                ...
                <Typography variant="h6" sx={{ color: themeColors.textMuted, maxWidth: 900, mb: 3 }}>
                ...
                >
                  This comprehensive guide covers threat actors, CTI methodology, IOCs, MITRE ATT&CK, current threat landscape, tracking tools, and defensive intelligence recommendations.
                </Alert>
              </Paper>
            </Box>
            ...
            <Box id="overview" sx={{ mt: 4, scrollMarginTop: 80 }}>
              ...
              >
                ...
                {/* Stats */}
                <Paper sx={{ p: 3, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Grid container spacing={3} justifyContent="center">
                    <Grid item xs={6} sm={3}>
                      <Box sx={{ textAlign: "center" }}>
                        <Typography variant="h4" sx={{ fontWeight: 800, color: themeColors.primary }}>{allActors.length}+</Typography>
                        <Typography variant="body2" sx={{ color: themeColors.textMuted }}>Threat Actors</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={6} sm={3}>
                      <Box sx={{ textAlign: "center" }}>
                        <Typography variant="h4" sx={{ fontWeight: 800, color: themeColors.secondary }}>{actorCategories.length}</Typography>
                        <Typography variant="body2" sx={{ color: themeColors.textMuted }}>Categories</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={6} sm={3}>
                      <Box sx={{ textAlign: "center" }}>
                        <Typography variant="h4" sx={{ fontWeight: 800, color: themeColors.accent }}>15+</Typography>
                        <Typography variant="body2" sx={{ color: themeColors.textMuted }}>Nations</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={6} sm={3}>
                      <Box sx={{ textAlign: "center" }}>
                        <Typography variant="h4" sx={{ fontWeight: 800, color: "#10b981" }}>2025</Typography>
                        <Typography variant="body2" sx={{ color: themeColors.textMuted }}>Updated</Typography>
                      </Box>
                    </Grid>
                  </Grid>
                </Paper>
                ...
                {/* Key Statistics 2024 */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>📈 Key Statistics (2024)</Typography>
                <Grid container spacing={2}>
                  {[
                    { stat: "$9.5T", label: "Global cybercrime cost", color: themeColors.primary },
                    { stat: "277", label: "Days avg breach detection", color: themeColors.secondary },
                    { stat: "$4.88M", label: "Average data breach cost", color: themeColors.accent },
                    ...
                    <Grid item xs={6} sm={4} md={2} key={item.label}>
                      <Box sx={{ textAlign: "center", p: 2, bgcolor: themeColors.bgNested, borderRadius: 2, border: `1px solid ${themeColors.border}` }}>
                        <Typography variant="h5" sx={{ fontWeight: 800, color: item.color }}>{item.stat}</Typography>
                        <Typography variant="caption" sx={{ color: themeColors.textMuted }}>{item.label}</Typography>
                      </Box>
                    </Grid>
                  ))}
                </Grid>
            ...
            <Box id="threat-actors" sx={{ mt: 4, scrollMarginTop: 80 }}>
              <Paper
                elevation={0}
                sx={{
                  bgcolor: themeColors.bgCard,
              ...
              >
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1 }}>
                    <BugReportIcon sx={{ color: themeColors.primary }} />
                    <Typography
                      variant="h5"
                      sx={{
                        fontWeight: 700,
                  ...
                  {actorCategories.map((cat, index) => (
                    <Card
                      ...
                      sx={{
                        ...
                        bgcolor: selectedCategory === index ? alpha(cat.color, 0.1) : themeColors.bgNested,
                        transition: "all 0.2s",
                    ...
                    >
                      <CardContent sx={{ textAlign: "center", p: 2, "&:last-child": { pb: 2 } }}>
                        ...
                        <Typography variant="caption" sx={{ color: themeColors.textMuted, fontSize: "0.65rem" }}>
                ...
                <Paper sx={{ borderRadius: 3, overflow: "hidden", bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Box sx={{ p: 3, bgcolor: alpha(actorCategories[selectedCategory].color, 0.05), borderBottom: `3px solid ${actorCategories[selectedCategory].color}` }}>
                    ...
                    <Typography variant="body2" sx={{ color: themeColors.textMuted }}>{actorCategories[selectedCategory].description}</Typography>
                  </Box>
                            ...
                            >
                              ...
                              <Box sx={{ display: "flex", gap: 0.5, mb: 1, flexWrap: "wrap", alignItems: "center" }}>
                                ...
                                {actor.targets.length > 2 && (
                                  <Typography variant="caption" sx={{ color: themeColors.textMuted, fontSize: "0.6rem" }}>
                              ...
                              {/* Description */}
                              <Typography variant="body2" sx={{ color: themeColors.textMuted, fontSize: "0.8rem", lineHeight: 1.5, mb: 1.5 }}>
                                {actor.description}
                              </Typography>
                              ...
                              {actor.notableCampaigns && actor.notableCampaigns.length > 0 && (
                                <Box sx={{ mt: 1, p: 1, bgcolor: alpha("#ef4444", 0.05), borderRadius: 1, borderLeft: `3px solid #ef4444` }}>
                                  ...
                                  <Typography variant="caption" sx={{ color: themeColors.textMuted, fontSize: "0.7rem" }}>
                              ...
                              {actor.ttps && actor.ttps.length > 0 && (
                                <Box sx={{ mt: 1, p: 1, bgcolor: alpha("#f59e0b", 0.05), borderRadius: 1, borderLeft: `3px solid #f59e0b` }}>
                                  ...
                                  <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                                    ...
                                    {actor.ttps.length > 6 && (
                                      <Typography variant="caption" sx={{ color: themeColors.textMuted, fontSize: "0.6rem", alignSelf: "center" }}>
            ...
            {/* CTI Methodology Section */}
            <Box id="methodology" sx={{ mt: 4, scrollMarginTop: 80 }}>
              <Paper
                elevation={0}
                sx={{
                  bgcolor: themeColors.bgCard,
              ...
              >
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1 }}>
                    <PsychologyIcon sx={{ color: themeColors.primary }} />
                    <Typography
                      variant="h5"
                      sx={{
                        fontWeight: 700,
                ...
                <Grid container spacing={3} sx={{ mb: 4 }}>
                  {ctiMethodology.map((section) => (
                    <Grid item xs={12} md={6} key={section.title}>
                      <Paper sx={{ p: 3, height: "100%", borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${alpha(section.color, 0.2)}` }}>
                        ...
                        {section.steps.map((step, i) => (
                          <Box key={i} sx={{ display: "flex", gap: 1.5, mb: 1.5 }}>
                            ...
                            <Typography variant="body2" sx={{ color: themeColors.textMuted }}>{step}</Typography>
                          </Box>
                        ))}
                      </Paper>
                    </Grid>
                ...
                {/* Diamond Model */}
                <Paper sx={{ p: 4, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Typography variant="h5" sx={{ fontWeight: 700, mb: 3 }}>💎 Diamond Model of Intrusion Analysis</Typography>
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={6}>
                      <Box sx={{ textAlign: "center", mb: 3 }}>
                        <Typography variant="body1" sx={{ color: themeColors.textMuted, mb: 2 }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "center", gap: 3, flexWrap: "wrap" }}>
                          {[
                            ...
                            <Box key={node.label} sx={{ textAlign: "center" }}>
                              ...
                              <Typography variant="caption" sx={{ color: themeColors.textMuted }}>{node.desc}</Typography>
                            </Box>
                          ))}
                        </Box>
                      </Box>
                    ...
                    <Grid item xs={12} md={6}>
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                        {[
                          ...
                          <Typography key={meta} variant="body2" sx={{ color: themeColors.textMuted }}>• {meta}</Typography>
                        ))}
                      </Box>
                    </Grid>
                  </Grid>
                      ...
                      <Grid item xs={12} sm={6} md={3} key={level.level}>
                        ...
                        >
                          ...
                          {level.indicators.map((ind, i) => (
                            <Typography key={i} variant="caption" sx={{ color: themeColors.textMuted, display: "block", mb: 0.5 }}>
                              • {ind}
                            </Typography>
                          ))}
                        </Paper>
                    ...
                    <Grid item xs={12} md={6}>
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                        {[
                          ...
                          <Typography key={item} variant="body2" sx={{ color: themeColors.textMuted }}>• {item}</Typography>
                        ))}
                      </Box>
                    </Grid>
                  </Grid>
                ...
                <Grid container spacing={3} sx={{ mb: 4 }}>
                  <Grid item xs={12} md={6}>
                    <Paper sx={{ p: 3, height: "100%", borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                        {tlpLevels.map((tlp) => (
                          <Box key={tlp.level} sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                            ...
                            <Typography variant="caption" sx={{ color: themeColors.textMuted }}>{tlp.desc}</Typography>
                          </Box>
                        ))}
                      </Box>
                    </Paper>
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                        {biases.map((bias) => (
                          <Box key={bias.name}>
                            ...
                            <Typography variant="caption" sx={{ color: themeColors.textMuted }}>{bias.desc}</Typography>
                          </Box>
                        ))}
                      </Box>
                    </Paper>
                ...
                <Paper sx={{ p: 4, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  ...
                  <Grid container spacing={4}>
                    <Grid item xs={12} md={6}>
                      ...
                      <TableContainer component={Paper} variant="outlined" sx={{ bgcolor: themeColors.bgCard }}>
                        <Table size="small">
                          <TableBody>
                ...
                {analysisTechniques.map((technique) => (
                  <Accordion key={technique.name} sx={{ mb: 1, borderRadius: 2, bgcolor: themeColors.bgNested, "&:before": { display: "none" } }}>
                    ...
                    <AccordionDetails>
                      <Typography variant="body2" sx={{ color: themeColors.textMuted, mb: 2 }}>{technique.description}</Typography>
                      <Grid container spacing={2}>
                        <Grid item xs={12} md={6}>
                          <Typography variant="subtitle2" sx={{ fontWeight: 700, mb: 1 }}>Steps:</Typography>
                          {technique.steps.map((step, i) => (
                            <Typography key={i} variant="body2" sx={{ color: themeColors.textMuted, mb: 0.5 }}>
                              {i + 1}. {step}
                            </Typography>
                          ))}
                        </Grid>
            ...
            {/* IOCs & MITRE Section */}
            <Box id="iocs-mitre" sx={{ mt: 4, scrollMarginTop: 80 }}>
              <Paper
                elevation={0}
                sx={{
                  bgcolor: themeColors.bgCard,
              ...
              >
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1 }}>
                    <RadarIcon sx={{ color: themeColors.primary }} />
                    <Typography
                      variant="h5"
                      sx={{
                        fontWeight: 700,
                    ...
                    >
                      📊 Indicators of Compromise (IOCs) & MITRE ATT&CK
                    </Typography>
                  </Box>
                  <Divider sx={{ mt: 2, borderColor: themeColors.border }} />
                </Box>
                ...
                {/* IOC Types */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>📋 IOC Types</Typography>
                <Grid container spacing={2} sx={{ mb: 4 }}>
                  {iocTypes.map((ioc) => (
                    <Grid item xs={12} sm={6} md={4} key={ioc.name}>
                      <Paper sx={{ p: 2, height: "100%", borderRadius: 2, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
                          <Typography variant="h5">{ioc.icon}</Typography>
                          <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>{ioc.name}</Typography>
                        </Box>
                        <Typography variant="body2" sx={{ color: themeColors.textMuted, mb: 1.5, fontSize: "0.8rem" }}>
                          {ioc.description}
                        </Typography>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>⚔️ MITRE ATT&CK Tactics</Typography>
                <Paper sx={{ p: 3, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                ...
                {/* Common Malware Families */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>🦠 Common Malware Families</Typography>
                <Grid container spacing={2} sx={{ mb: 4 }}>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>📐 Pyramid of Pain</Typography>
                <Paper sx={{ p: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Typography variant="body2" sx={{ color: themeColors.textMuted, mb: 3, textAlign: "center" }}>
                    ...
                    {[
                      ...
                      <Tooltip key={item.level} title={item.desc} arrow placement="right">
                        ...
                        >
                          ...
                          <Typography variant="caption" sx={{ color: themeColors.textMuted }}>{item.pain}</Typography>
                        </Paper>
                      </Tooltip>
                    ))}
                  </Box>
            ...
            <Box id="threat-landscape" sx={{ mt: 4, scrollMarginTop: 80 }}>
              <Paper
                elevation={0}
                sx={{
                  bgcolor: themeColors.bgCard,
              ...
              >
                      ...
                      <Paper sx={{ p: 2, height: "100%", borderRadius: 2, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                          {threat.keyStats.map((stat, i) => (
                            <Typography key={i} variant="caption" sx={{ color: themeColors.textMuted }}>
                              • {stat}
                            </Typography>
                          ))}
                        </Box>
                ...
                {/* Emerging Threats */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>⚠️ Emerging Threats to Watch</Typography>
                <Grid container spacing={2} sx={{ mb: 4 }}>
                  {[
                    { 
                    ...
                    <Grid item xs={12} sm={6} md={4} key={threat.title}>
                      <Paper sx={{ p: 2, height: "100%", borderRadius: 2, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                        ...
                        <Typography variant="body2" sx={{ color: themeColors.textMuted, mb: 1, fontSize: "0.8rem" }}>
                          {threat.description}
                        </Typography>
                        <Chip 
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>🌍 Geopolitical Cyber Context</Typography>
                <Paper sx={{ p: 3, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Grid container spacing={3}>
                    {[
                      ...
                      <Grid item xs={12} md={6} key={item.region}>
                        <Box sx={{ display: "flex", gap: 2 }}>
                          ...
                          <Box>
                            ...
                            <Typography variant="body2" sx={{ color: themeColors.textMuted, fontSize: "0.8rem" }}>{item.impact}</Typography>
                          </Box>
                        </Box>
                      </Grid>
                    ))}
            ...
            <Box id="tracking-tools" sx={{ mt: 4, scrollMarginTop: 80 }}>
              <Paper
                elevation={0}
                sx={{
                  bgcolor: themeColors.bgCard,
              ...
              >
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1 }}>
                    <TrackChangesIcon sx={{ color: themeColors.primary }} />
                    <Typography
                      variant="h5"
                      sx={{
                        fontWeight: 700,
                ...
                <TableContainer component={Paper} sx={{ mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested }}>
                  <Table>
                    <TableHead>
                      <TableRow sx={{ bgcolor: alpha(themeColors.primary, 0.05) }}>
                    ...
                    <TableBody>
                      {trackingMethods.map((row) => (
                        <TableRow key={row.method}>
                          ...
                          <TableCell sx={{ color: themeColors.textMuted }}>{row.description}</TableCell>
                          <TableCell>
                            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                ...
                {/* Pivot Searching */}
                <Paper sx={{ p: 3, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, color: themeColors.primaryLight }}>🔍 Pivot Searching Techniques</Typography>
                  <Grid container spacing={2}>
                    {pivotTechniques.map((tech) => (
                      <Grid item xs={12} sm={6} md={4} key={tech.name}>
                        <Box sx={{ p: 2, border: `1px solid ${themeColors.border}`, borderRadius: 2, bgcolor: themeColors.bgCard }}>
                          <Typography variant="subtitle2" sx={{ fontWeight: 700, color: themeColors.primary, mb: 1 }}>{tech.name}</Typography>
                          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                            {tech.pivots.map((p) => (
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 3, color: themeColors.primaryLight }}>📚 Intelligence Sources Database</Typography>
                
                {/* Free Sources */}
                <Paper sx={{ p: 3, mb: 3, borderRadius: 3, bgcolor: themeColors.bgNested, border: `2px solid ${alpha("#10b981", 0.3)}` }}>
                        ...
                        <Link href={source.url} target="_blank" rel="noopener" underline="none">
                          <Paper 
                            ...
                            sx={{ 
                              ...
                              "&:hover": { bgcolor: alpha(themeColors.primary, 0.05), borderColor: themeColors.primary } 
                            }}
                          >
                            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 0.5 }}>
                              <Typography variant="subtitle2" sx={{ fontWeight: 700, color: themeColors.primary }}>{source.name}</Typography>
                              <LaunchIcon fontSize="small" sx={{ fontSize: 12, ml: "auto", color: themeColors.textMuted }} />
                            </Box>
                            <Chip label={source.category} size="small" sx={{ fontSize: "0.6rem", height: 18, mb: 0.5 }} />
                            <Typography variant="caption" sx={{ display: "block", fontSize: "0.7rem", color: themeColors.textMuted }}>
                              {source.description}
                            </Typography>
                          </Paper>
                        </Link>
                ...
                {/* Commercial Sources */}
                <Paper sx={{ p: 3, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `2px solid ${alpha("#f59e0b", 0.3)}` }}>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 3, color: themeColors.primaryLight }}>🏛️ Government CTI Resources</Typography>
                <Grid container spacing={2}>
                  {[
                    ...
                    <Grid item xs={12} sm={6} md={4} key={resource.name}>
                      <Link href={resource.url} target="_blank" rel="noopener" underline="none">
                        <Paper sx={{ p: 2, transition: "all 0.2s", bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}`, "&:hover": { bgcolor: alpha(themeColors.primary, 0.05) } }}>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            <LaunchIcon fontSize="small" sx={{ fontSize: 14, ml: "auto", color: themeColors.textMuted }} />
                          </Box>
                        </Paper>
                      </Link>
                    </Grid>
            ...
            {/* Defensive Intel Section */}
            <Box id="defensive-intel" sx={{ mt: 4, scrollMarginTop: 80 }}>
              <Paper
                elevation={0}
                sx={{
                  bgcolor: themeColors.bgCard,
              ...
              >
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1 }}>
                    ...
                    >
                      🛡️ Defensive Intelligence & Recommendations
                    </Typography>
                  </Box>
                  <Divider sx={{ mt: 2, borderColor: themeColors.border }} />
                </Box>
                ...
                {/* Report Templates */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 3, color: themeColors.primaryLight }}>📝 Intelligence Report Templates</Typography>
                <Grid container spacing={2} sx={{ mb: 4 }}>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 3, color: themeColors.primaryLight }}>🎯 Detection Priority Matrix</Typography>
                <Paper sx={{ p: 3, mb: 4, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Grid container spacing={2}>
                    {[
                ...
                {/* Incident Response Quick Reference */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 3, color: themeColors.primaryLight }}>🚨 Incident Response Quick Reference</Typography>
                <Grid container spacing={2} sx={{ mb: 4 }}>
                  {[
                    { 
                      phase: "1. Preparation", 
                    ...
                    <Grid item xs={12} sm={6} md={4} key={phase.phase}>
                      ...
                      >
                        ...
                        {phase.tasks.map((task, i) => (
                          <Typography key={i} variant="body2" sx={{ color: themeColors.textMuted, mb: 0.5, fontSize: "0.8rem" }}>
                            • {task}
                          </Typography>
                        ))}
                      </Paper>
                ...
                {/* Threat Hunting Hypotheses */}
                <Typography variant="h6" sx={{ fontWeight: 700, mb: 3, color: themeColors.primaryLight }}>🎣 Threat Hunting Hypothesis Examples</Typography>
                <Paper sx={{ p: 3, borderRadius: 3, bgcolor: themeColors.bgNested, border: `1px solid ${themeColors.border}` }}>
                  <Grid container spacing={2}>
                    {[
                      ...
                      <Grid item xs={12} md={6} key={i}>
                        <Box sx={{ p: 2, bgcolor: themeColors.bgCard, borderRadius: 2, border: `1px solid ${themeColors.border}` }}>
                          <Typography variant="subtitle2" sx={{ fontWeight: 700, color: themeColors.primary, mb: 0.5 }}>
                            Hypothesis: {item.hypothesis}
                          </Typography>
                          <Typography variant="body2" sx={{ color: themeColors.textMuted, fontSize: "0.8rem" }}>
      ...
      <Drawer
        ...
        PaperProps={{ sx: { width: 280, bgcolor: themeColors.bgCard, borderRight: `1px solid ${themeColors.border}` } }}
      >
        <Box sx={{ p: 2 }}>
      ...
      {/* Mobile FABs */}
      <Box sx={{ display: { xs: "flex", md: "none" }, position: "fixed", bottom: 16, right: 16, gap: 1, flexDirection: "column" }}>
        <Fab
          size="small"
          onClick={() => setMobileNavOpen(true)}
          sx={{ bgcolor: themeColors.primary, "&:hover": { bgcolor: themeColors.primaryLight } }}
        >
        ...
        <Fab
          ...
          sx={{ bgcolor: themeColors.bgCard, border: `1px solid ${themeColors.border}` }}
        >
          <KeyboardArrowUpIcon sx={{ color: themeColors.primary }} />
        </Fab>
      </Box>
    </LearnPageLayout>
  );
