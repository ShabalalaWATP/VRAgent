...
const NETWORK_PORTS: PortInfo[] = [
  ...
  { port: 530, protocol: "TCP/UDP", service: "RPC", description: "Remote Procedure Call", category: "Infrastructure", security: "insecure" },
  { port: 543, protocol: "TCP", service: "Klogin", description: "Kerberos login", category: "Authentication", security: "deprecated" },
  { port: 544, protocol: "TCP", service: "Kshell", description: "Kerberos shell", category: "Authentication", security: "deprecated" },
  { port: 546, protocol: "TCP/UDP", service: "DHCPv6 Client", description: "DHCP for IPv6 - Client", category: "Infrastructure", security: "varies" },
  { port: 547, protocol: "TCP/UDP", service: "DHCPv6 Server", description: "DHCP for IPv6 - Server", category: "Infrastructure", security: "varies" },
  { port: 548, protocol: "TCP", service: "AFP", description: "Apple Filing Protocol", category: "File Transfer", security: "varies" },
  { port: 554, protocol: "TCP", service: "RTSP", description: "Real Time Streaming Protocol", category: "Streaming", security: "insecure" },
  ...
  { port: 902, protocol: "TCP", service: "VMware", description: "VMware Server Console", category: "Virtualization", security: "varies" },
  { port: 989, protocol: "TCP", service: "FTPS Data", description: "FTP over SSL - Data", category: "File Transfer", security: "secure" },
  { port: 990, protocol: "TCP", service: "FTPS Control", description: "FTP over SSL - Control", category: "File Transfer", security: "secure" },
  ...
  { port: 2082, protocol: "TCP", service: "cPanel", description: "cPanel web hosting control", category: "Web", security: "insecure" },
  { port: 2083, protocol: "TCP", service: "cPanel SSL", description: "cPanel over SSL", category: "Web", security: "secure" },
  { port: 2181, protocol: "TCP", service: "ZooKeeper", description: "Apache ZooKeeper", category: "Infrastructure", security: "varies" },
  ...
  { port: 3268, protocol: "TCP", service: "Global Catalog", description: "Active Directory Global Catalog", category: "Windows", security: "varies" },
  { port: 3269, protocol: "TCP", service: "Global Catalog SSL", description: "AD Global Catalog over SSL", category: "Windows", security: "secure" },
  ...
  { port: 3478, protocol: "TCP/UDP", service: "STUN", description: "Session Traversal for NAT", category: "VoIP", security: "varies" },
  { port: 4369, protocol: "TCP", service: "EPMD", description: "Erlang Port Mapper Daemon", category: "Infrastructure", security: "varies" },
  { port: 4500, protocol: "UDP", service: "IPsec NAT-T", description: "IPsec NAT Traversal", category: "VPN", security: "secure" },
  ...
  { port: 5222, protocol: "TCP", service: "XMPP Client", description: "Jabber/XMPP client connection", category: "Messaging", security: "varies" },
  { port: 5269, protocol: "TCP", service: "XMPP Server", description: "Jabber/XMPP server-to-server", category: "Messaging", security: "varies" },
  ...
  { port: 5938, protocol: "TCP", service: "TeamViewer", description: "TeamViewer remote access", category: "Remote Access", security: "varies" },
  { port: 5984, protocol: "TCP", service: "CouchDB", description: "Apache CouchDB", category: "Database", security: "varies" },
  { port: 5985, protocol: "TCP", service: "WinRM HTTP", description: "Windows Remote Management", category: "Windows", security: "varies" },
  { port: 5986, protocol: "TCP", service: "WinRM HTTPS", description: "Windows Remote Management (SSL)", category: "Windows", security: "secure" },
  ...
  { port: 6666, protocol: "TCP", service: "IRC Alt", description: "IRC alternative port", category: "Messaging", security: "insecure" },
  { port: 6667, protocol: "TCP", service: "IRC", description: "Internet Relay Chat (standard)", category: "Messaging", security: "insecure" },
  { port: 6697, protocol: "TCP", service: "IRC TLS", description: "IRC over TLS", category: "Messaging", security: "secure" },
  { port: 7001, protocol: "TCP", service: "WebLogic", description: "Oracle WebLogic Server", category: "Application", security: "varies" },
  { port: 7002, protocol: "TCP", service: "WebLogic SSL", description: "Oracle WebLogic over SSL", category: "Application", security: "secure" },
  { port: 8000, protocol: "TCP", service: "HTTP Alt", description: "Alternative HTTP port", category: "Web", security: "insecure" },
  { port: 8008, protocol: "TCP", service: "HTTP Alt", description: "Alternative HTTP port", category: "Web", security: "insecure" },
  { port: 8080, protocol: "TCP", service: "HTTP Proxy", description: "HTTP proxy/alternative port", category: "Web", security: "insecure" },
  { port: 8081, protocol: "TCP", service: "HTTP Alt", description: "Alternative HTTP/proxy port", category: "Web", security: "insecure" },
  ...
  { port: 8888, protocol: "TCP", service: "HTTP Alt", description: "Alternative HTTP port", category: "Web", security: "insecure" },
  { port: 9000, protocol: "TCP", service: "PHP-FPM", description: "PHP FastCGI Process Manager", category: "Web", security: "varies" },
  { port: 9001, protocol: "TCP", service: "Tor Control", description: "Tor control port", category: "Proxy", security: "varies" },
  { port: 9042, protocol: "TCP", service: "Cassandra", description: "Apache Cassandra CQL", category: "Database", security: "varies" },
  ...
  { port: 9300, protocol: "TCP", service: "Elasticsearch", description: "Elasticsearch transport", category: "Database", security: "varies" },
  { port: 9418, protocol: "TCP", service: "Git", description: "Git protocol", category: "Development", security: "insecure" },
  { port: 9443, protocol: "TCP", service: "HTTPS Alt", description: "Alternative HTTPS port", category: "Web", security: "secure" },
  { port: 10000, protocol: "TCP", service: "Webmin", description: "Webmin administration", category: "Management", security: "varies" },
  { port: 10050, protocol: "TCP", service: "Zabbix Agent", description: "Zabbix monitoring agent", category: "Management", security: "varies" },
  { port: 10051, protocol: "TCP", service: "Zabbix Server", description: "Zabbix monitoring server", category: "Management", security: "varies" },
  { port: 11211, protocol: "TCP", service: "Memcached", description: "Memcached cache server", category: "Database", security: "insecure" },
  { port: 15672, protocol: "TCP", service: "RabbitMQ", description: "RabbitMQ management UI", category: "Messaging", security: "varies" },
  { port: 27017, protocol: "TCP", service: "MongoDB", description: "MongoDB database", category: "Database", security: "varies" },
  { port: 27018, protocol: "TCP", service: "MongoDB Shard", description: "MongoDB shard server", category: "Database", security: "varies" },
  { port: 28017, protocol: "TCP", service: "MongoDB Web", description: "MongoDB web status", category: "Database", security: "varies" },
  { port: 50000, protocol: "TCP", service: "Jenkins", description: "Jenkins agent communication", category: "Development", security: "varies" },
  { port: 50070, protocol: "TCP", service: "HDFS", description: "Hadoop HDFS NameNode", category: "Big Data", security: "varies" },
  { port: 51820, protocol: "UDP", service: "WireGuard", description: "WireGuard VPN", category: "VPN", security: "secure" },
];

const DynamicAnalysisHub: React.FC = () => {
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Analyze network traffic, perform active scanning, and test endpoints with AI-powered security insights
            </Typography>
          </Box>
        </Box>
        <Chip
          ...
          label="Learn About Dynamic Analysis →"
          clickable
          size="small"
          sx={{
            ...
            <CardContent sx={{ p: 3, display: "flex", flexDirection: "column", flex: 1 }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="caption" color="text.secondary">
                    AI-Orchestrated Pentesting
                  </Typography>
                </Box>
              </Box>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2, flex: 1 }}>
                Automated pentesting workflow: Nmap discovery → ZAP web scanning → Nuclei CVE detection 
                → Exploit mapping. AI generates attack narratives and Metasploit commands.
              </Typography>
              <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap", mb: 2 }}>
                <Chip label="Nmap" size="small" variant="outlined" />
                <Chip label="Nuclei" size="small" variant="outlined" />
                <Chip label="AI Analysis" size="small" variant="outlined" />
              </Box>
              <Button
                component={Link}
                to="/dynamic/dynamic-scanner"
                variant="contained"
                fullWidth
                sx={{
                  mt: "auto",
            ...
            <CardContent sx={{ p: 3, display: "flex", flexDirection: "column", flex: 1 }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
                ...
                <Box>
                  ...
                  <Typography variant="caption" color="text.secondary">
                    Path Analysis & Port Scanning
                  </Typography>
                </Box>
              </Box>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2, flex: 1 }}>
                Traceroute visualization, Nmap port scanning, service detection, and vulnerability analysis.
              </Typography>
              <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap", mb: 2 }}>
                  ...
                  <TableCell align="right">
                    <Tooltip title="View Report">
                      <IconButton
                        ...
                        onClick={() =>
                          navigate(
                            `/dynamic/${report.analysis_type}?reportId=${report.id}`
                          )
                        }
                      >
...
export default DynamicAnalysisHub;
